              ...
              Expanded(
                child: Center(
                  child: SingleChildScrollView(
                    padding: EdgeInsets.symmetric(vertical: MediaQuery.of(context).size.width < 600 ? 16 : 40, horizontal: MediaQuery.of(context).size.width < 600 ? 12 : 24),
                    child: Container(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    child: _currentStockItem.productUrl.isNotEmpty
                                          ? ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl: kIsWeb 
                                                  ? 'https://corsproxy.io/?${Uri.encodeComponent(_currentStockItem.productUrl)}' 
                            ...
                            Builder(
                              builder: (context) {
                                bool isMobileForm = MediaQuery.of(context).size.width < 600;
                                if (isMobileForm) {
                                  return Column(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
